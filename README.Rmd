...
> {svTidy} provides functions equivalent to [{dplyr}](https://dplyr.tidyverse.org) and [{tidyr}](https://tidyr.tidyverse.org), but using either a standard evaluation of arguments or formulas, both being closer to base R syntax. Its functions are also usually faster and consume less RAM.
...
You can install the development version of {svTidy} from the [SciViews R-universe](https://sciviews.r-universe.dev) with:
...
Being still in the experimental stage, it is not available yet on [CRAN](https://cran.r-project.org), but it will be submitted as soon as it matures.
